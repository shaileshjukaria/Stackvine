 ...
 *
 * To activate: set VITE_WHATSAPP_NUMBER in client/.env
 * Example: VITE_WHATSAPP_NUMBER=919876543210
 * (country code + number, no + sign, no spaces)
 */
const WA_NUMBER = import.meta.env.VITE_WHATSAPP_NUMBER;
const WA_MESSAGE = encodeURIComponent(
  "Hi Stackvine! I visited your website and I'm interested in discussing a project. 👋"
);
  ...
  return (
    <a
      ...
      onMouseEnter={e => {
        ...
        e.currentTarget.style.boxShadow = '0 8px 28px rgba(37,211,102,.55)';
      }}
      onMouseLeave={e => {
